...
public class RuminantChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(21, new ItemStack(CCItems.HERBIVORE_RUMEN, CCItems.HERBIVORE_RUMEN.getMaxCount()));
