...
public class GhastChestCavity extends BaseChestCavity implements ChestCavityType {
    ...
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(1, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        chestCavity.setStack(2, new ItemStack(CCItems.ANIMAL_APPENDIX, CCItems.ANIMAL_APPENDIX.getMaxCount()));
        chestCavity.setStack(3, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        chestCavity.setStack(4, new ItemStack(CCItems.ANIMAL_HEART, CCItems.ANIMAL_HEART.getMaxCount()));
        chestCavity.setStack(5, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        chestCavity.setStack(6, ItemStack.EMPTY);
        chestCavity.setStack(7, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        ...
        chestCavity.setStack(22, new ItemStack(CCItems.VOLATILE_STOMACH, CCItems.VOLATILE_STOMACH.getMaxCount()));
