...
public class SmallCarnivoreChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(20, new ItemStack(CCItems.SMALL_CARNIVORE_INTESTINE, CCItems.SMALL_CARNIVORE_INTESTINE.getMaxCount()));
        chestCavity.setStack(21, new ItemStack(CCItems.SMALL_CARNIVORE_INTESTINE, CCItems.SMALL_CARNIVORE_INTESTINE.getMaxCount()));
        chestCavity.setStack(22, new ItemStack(CCItems.SMALL_CARNIVORE_STOMACH, CCItems.SMALL_CARNIVORE_STOMACH.getMaxCount()));
        chestCavity.setStack(23, new ItemStack(CCItems.SMALL_CARNIVORE_INTESTINE, CCItems.SMALL_CARNIVORE_INTESTINE.getMaxCount()));
        chestCavity.setStack(24, new ItemStack(CCItems.SMALL_CARNIVORE_INTESTINE, CCItems.SMALL_CARNIVORE_INTESTINE.getMaxCount()));
    ...
    public void generateRareOrganDrops(Random random, int looting, List<ItemStack> loot) {
        ...
        for(int i = 0; i < 4; i++){
            organPile.add(CCItems.SMALL_CARNIVORE_INTESTINE);
        }
