...
public class HerbivoreChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(23, new ItemStack(CCItems.HERBIVORE_INTESTINE, CCItems.HERBIVORE_INTESTINE.getMaxCount()));
