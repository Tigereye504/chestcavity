...
public class ShulkerChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(11, new ItemStack(CCItems.SHULKER_SPLEEN, CCItems.SHULKER_SPLEEN.getMaxCount()));
