...
public class LargeFishChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        chestCavity.clear();
        chestCavity.setStack(0, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        ...
        chestCavity.setStack(8, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        chestCavity.setStack(9, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        ...
        chestCavity.setStack(17, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        chestCavity.setStack(18, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        chestCavity.setStack(19, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        ...
        chestCavity.setStack(25, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
        chestCavity.setStack(26, new ItemStack(CCItems.FISH_MUSCLE, CCItems.FISH_MUSCLE.getMaxCount()));
    }
    ...
    public void generateRareOrganDrops(Random random, int looting, List<ItemStack> loot) {
        ...
        for(int i = 0; i < 8; i++){
            organPile.add(CCItems.FISH_MUSCLE);
        }
        for(int i = 0; i < 4; i++){
