...
public class LlamaChestCavity extends BaseChestCavity implements ChestCavityType {
    @Override
    public void fillChestCavityInventory(ChestCavityInventory chestCavity) {
        ...
        chestCavity.setStack(3, new ItemStack(CCItems.LLAMA_LUNG, CCItems.LLAMA_LUNG.getMaxCount()));
        chestCavity.setStack(4, new ItemStack(CCItems.ANIMAL_HEART, CCItems.ANIMAL_HEART.getMaxCount()));
        chestCavity.setStack(5, new ItemStack(CCItems.LLAMA_LUNG, CCItems.LLAMA_LUNG.getMaxCount()));
        ...
        chestCavity.setStack(20, new ItemStack(CCItems.HERBIVORE_INTESTINE, CCItems.HERBIVORE_INTESTINE.getMaxCount()));
        chestCavity.setStack(21, new ItemStack(CCItems.HERBIVORE_INTESTINE, CCItems.HERBIVORE_INTESTINE.getMaxCount()));
        chestCavity.setStack(22, new ItemStack(CCItems.HERBIVORE_STOMACH, CCItems.HERBIVORE_STOMACH.getMaxCount()));
        chestCavity.setStack(23, new ItemStack(CCItems.HERBIVORE_RUMEN, CCItems.HERBIVORE_RUMEN.getMaxCount()));
        chestCavity.setStack(24, new ItemStack(CCItems.HERBIVORE_INTESTINE, CCItems.HERBIVORE_INTESTINE.getMaxCount()));
    ...
    public void generateRareOrganDrops(Random random, int looting, List<ItemStack> loot) {
        ...
        organPile.add(CCItems.LLAMA_LUNG);
        organPile.add(CCItems.LLAMA_LUNG);
