...
public class CCOrganScores {
    ...
    public static final Identifier HEART = new Identifier(ChestCavity.MODID, "heart");
    public static final Identifier INTESTINE = new Identifier(ChestCavity.MODID, "intestine");
