...
public class CCLootConditionTypes {
    public static LootConditionType CHEST_CAVITY_UNOPENED;

    public static void register(){
        CHEST_CAVITY_UNOPENED = register("chest_cavity_unopened", new ChestCavityUnopenedLootCondition.Serializer());
    }
