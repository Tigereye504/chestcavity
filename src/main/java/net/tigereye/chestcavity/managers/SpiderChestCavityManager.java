...
public class SpiderChestCavityManager extends ChestCavityManager{


    public SpiderChestCavityManager(LivingEntity owner) {
        super(owner);
    }
    public SpiderChestCavityManager(LivingEntity owner, int size) {
        super(owner,size);
    }
    ...
    private static void initializeDefaultOrganScores(){
        ...
        defaultOrganScores.put(CCOrganScores.SILK,2f);
    }
    ...
    public void fillChestCavityInventory() {
        ...
        chestCavity.setStack(25, new ItemStack(CCItems.SILK_GLAND, CCItems.SILK_GLAND.getMaxCount()));
