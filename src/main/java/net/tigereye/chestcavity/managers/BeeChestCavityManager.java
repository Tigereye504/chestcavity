...
public class BeeChestCavityManager extends ChestCavityManager{


    public BeeChestCavityManager(LivingEntity owner) {
        super(owner);
    }
    public BeeChestCavityManager(LivingEntity owner, int size) {
        super(owner,size);
    }
